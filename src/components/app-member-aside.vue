<!--
* @description 个人中心左侧边栏组件
* @fileName app-aside.vue
* @author echo9z
* @date 2022/08/22 17:58:44
!-->
<template>
  <div class="e-member-aside">
    <div class="user-manage">
      ...
      <div class="links">
        <!-- 在vue2中可以实现
          ...
          但在vue3中需要配置/member/order路由，比如访问/member/order/:id 使得在访问 /member/order/1001 有激活效果
        -->
        <RouterLink active-class="active" to="/member/order">我的订单</RouterLink>
